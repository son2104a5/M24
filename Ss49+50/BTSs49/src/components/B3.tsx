export default function B3() {
  return (
    <div>
        <strong className='text-3xl'>B3:</strong>
        <div className="flex">
            ...
            <div className='p-[50px] pl-[120px]'>
                <h1 className='mb-[50px] text-[64px]'>Login Account</h1>
                ...
                <p className='p-2 text-white rounded bg-blue-600 text-center w-[350px]'>Login an account</p>
                <p className='text-center mt-5'>No have an account? <strong>Register here</strong></p>
            </div>
        </div>
    </div>
  )
