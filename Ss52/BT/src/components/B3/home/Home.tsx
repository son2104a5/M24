            ...
            <div className="container">
              <div className="site-navigation">
                ...
                <ul className="js-clone-nav d-none d-lg-inline-block text-left site-menu float-right">
                  ...
                  <li>
                    <Link to={'/tour/services'}>Services</Link>
                  </li>
                  <li>
                    <Link to={'/tour/about'}>About</Link>
                  </li>
                  <li>
                    <Link to={'/tour/contact'}>Contact Us</Link>
                  </li>
                </ul>
                <a
                  href="#"
                  ...
                  <div className="h-100">
                    <div className="frame h-100">
                      <div
                        ...
                        style={{ backgroundImage: 'url("../src/assets/images/hero-slider-1.jpg")' }}
                      />
                    </div>
                  </div>
                </div>
              ...
              <div className="owl-carousel owl-3-slider">
                <div className="item">
                  <a
                    ...
                    href="../src/assets/images/hero-slider-1.jpg"
                  ...
                  >
                    ...
                    <img
                      src="../src/assets/images/hero-slider-1.jpg"
                      alt="Image"
                      className="img-fluid"
                    />
                  </a>
                ...
                <div className="item">
                  <a
                    className="media-thumb"
                    href="../src/assets/images/hero-slider-2.jpg"
                    data-fancybox="gallery"
                  >
                    <div className="media-text">
                      <h3>Oia</h3>
                ...
                <div className="item">
                  <a
                    className="media-thumb"
                    href="../src/assets/images/hero-slider-3.jpg"
                    data-fancybox="gallery"
                  >
                    <div className="media-text">
                    ...
                    <img
                      src="../src/assets/images/hero-slider-3.jpg"
                      alt="Image"
                      className="img-fluid"
                    />
                  </a>
                ...
                <div className="item">
                  <a
                    className="media-thumb"
                    href="../src/assets/images/hero-slider-4.jpg"
                    data-fancybox="gallery"
                  >
                    <div className="media-text">
                      <h3>Rialto Bridge</h3>
                    ...
                    <img
                      src="../src/assets/images/hero-slider-4.jpg"
                      alt="Image"
                      className="img-fluid"
                    />
                  </a>
                ...
                <div className="item">
                  <a
                    className="media-thumb"
                    href="../src/assets/images/hero-slider-5.jpg"
                    data-fancybox="gallery"
                  >
                    <div className="media-text">
                    ...
                    <img
                      src="../src/assets/images/hero-slider-5.jpg"
                      alt="Image"
                      className="img-fluid"
                    />
                  </a>
