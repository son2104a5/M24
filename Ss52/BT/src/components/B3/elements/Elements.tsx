        ...
        <div className="col-lg-4">
          ...
          <div className="custom-block" data-aos="fade-up">
            ...
            <div className="row gutter-v2 gallery">
              <div className="col-4">
                <a
                  href="../src/assets/images/gal_1.jpg"
                  className="gal-item"
                  data-fancybox="gal"
                >
                  <img
                    src="../src/assets/images/gal_1.jpg"
                    alt="Image"
                    className="img-fluid"
                  />
                </a>
              ...
              <div className="col-4">
                <a
                  href="../src/assets/images/gal_2.jpg"
                  className="gal-item"
                  data-fancybox="gal"
                >
                  <img
                    src="../src/assets/images/gal_2.jpg"
                    alt="Image"
                    className="img-fluid"
                  />
                </a>
              ...
              <div className="col-4">
                <a
                  href="../src/assets/images/gal_3.jpg"
                  className="gal-item"
                  data-fancybox="gal"
                >
                  <img
                    src="../src/assets/images/gal_3.jpg"
                    alt="Image"
                    className="img-fluid"
                  />
                </a>
              ...
              <div className="col-4">
                <a
                  href="../src/assets/images/gal_4.jpg"
                  className="gal-item"
                  data-fancybox="gal"
                >
                  <img
                    src="../src/assets/images/gal_4.jpg"
                    alt="Image"
                    className="img-fluid"
                  />
                </a>
              ...
              <div className="col-4">
                <a
                  href="../src/assets/images/gal_5.jpg"
                  className="gal-item"
                  data-fancybox="gal"
                >
                  <img
                    src="../src/assets/images/gal_5.jpg"
                    alt="Image"
                    className="img-fluid"
                  />
                </a>
              ...
              <div className="col-4">
                <a
                  href="../src/assets/images/gal_6.jpg"
                  className="gal-item"
                  data-fancybox="gal"
                >
                  <img
                    src="../src/assets/images/gal_6.jpg"
                    alt="Image"
                    className="img-fluid"
                  />
                </a>
